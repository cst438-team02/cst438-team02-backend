...
public class RegistrarServiceProxy {
    ...
    public void addCourse(CourseDTO dto) {
        send("addCourse " + asJsonString(dto));
    }

    public void updateCourse(CourseDTO dto) {
        send("updateCourse " + asJsonString(dto));
    }

    public void deleteCourse(String courseId) {
        send("deleteCourse " + courseId);
    }

    public void addSection(SectionDTO dto) {
        send("addSection " + asJsonString(dto));
    }

    public void updateSection(SectionDTO dto) {
        send("updateSection " + asJsonString(dto));
    }

    public void deleteSection(String sectionId) {
        send("deleteSection " + sectionId);
    }

    public void addUser(UserDTO dto) {
        send("addUser " + asJsonString(dto));
    }

    public void updateUser(UserDTO dto) {
        send("updateUser " + asJsonString(dto));
    }
    ...
    public void addEnrollment(EnrollmentDTO dto) {
        send("addEnrollment " + asJsonString(dto));
    }

    public void updateEnrollment(EnrollmentDTO dto) {
        send("updateEnrollment " + asJsonString(dto));
    }

    public void deleteEnrollment(String enrollmentId) {
        send("deleteEnrollment " + enrollmentId);
    }

    public void sendFinalGrade(FinalGradeDTO dto) {
        send("updateFinalGrade " + asJsonString(dto));
    }
